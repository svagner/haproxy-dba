 ...
 */
struct uri_scope {
	struct uri_scope *next;	/* next entry, NULL if none */
...
struct uri_auth {
	...
	struct uri_scope *scope;	/* linked list of authorized proxies */
...
#ifdef CONFIG_DBMANAGE_DEFAULT_URI
#define DBMANAGE_DEFAULT_URI CONFIG_DBMANAGE_DEFAULT_URI
#else
#define DBMANAGE_DEFAULT_URI "/dbmanage"
#endif
